...
public class PersistentTasksNodeServiceTests extends ESTestCase {
    ...
    public void testParamsStatusAndNodeTaskAreDelegated() throws Exception {
        ...
        tasks.addTask(
            ...
            TestPersistentTasksExecutor.NAME,
            taskParams,
            new Assignment("this_node", PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "test assignment on other node")
        );
    ...
    public void testRegisterTaskFails() throws InterruptedException {
        ...
        tasks.addTask(
            ...
            TestPersistentTasksExecutor.NAME,
            new TestParams("this_param"),
            new Assignment("this_node", PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "test assignment on this node")
        );
                ...
                Metadata.builder(state.metadata())
                    .putCustom(
                        ...
                        builder.addTask(
                            ...
                            action,
                            params,
                            new Assignment(node, PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "test assignment")
                        ).build()
                    )
            )
            .build();
