...
public class PersistentTasksClusterServiceTests extends ESTestCase {
    ...
    public void testPersistentTasksChangedTaskAdded() {
        ...
        PersistentTasksCustomMetadata tasks = PersistentTasksCustomMetadata.builder()
            .addTask("_task_1", "test", null, new Assignment(null, PersistentTasksCustomMetadata.Explanation.GENERIC_REASON, "_reason"))
            .build();
    ...
    public void testPersistentTasksChangedTaskRemoved() {
        ...
        PersistentTasksCustomMetadata previousTasks = PersistentTasksCustomMetadata.builder()
            .addTask(
                ...
                "test",
                null,
                new Assignment("_node_1", PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "_reason")
            )
            .addTask(
                "_task_2",
                "test",
            ...
            .addTask(
                ...
                "test",
                null,
                new Assignment("_node_2", PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "_reason")
            )
            .build();
    ...
    public void testPersistentTasksAssigned() {
        ...
        PersistentTasksCustomMetadata previousTasks = PersistentTasksCustomMetadata.builder()
            ...
            .addTask("_task_2", "test", null, new Assignment(null, PersistentTasksCustomMetadata.Explanation.GENERIC_REASON, "unassigned"))
            .build();
    ...
    public void testNeedsReassignment() {
        ...
        assertTrue(needsReassignment(new Assignment(null, PersistentTasksCustomMetadata.Explanation.GENERIC_REASON, "unassigned"), nodes));
        assertTrue(
            needsReassignment(
                new Assignment(
                    "_node_left",
        ...
        assertFalse(
            needsReassignment(new Assignment("_node_1", PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "assigned"), nodes)
        );
    }
    ...
    private Assignment randomNodeAssignment(Collection<DiscoveryNode> nodes) {
        ...
        return Optional.ofNullable(randomFrom(nodes))
            .map(node -> new Assignment(node.getId(), PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "test assignment"))
        ...
        if (hasAssignableTasks(tasks, clusterState.nodes()) == false) {
            ...
            if (randomBoolean()) {
                ...
                addRandomTask(
                    ...
                    new Assignment(null, PersistentTasksCustomMetadata.Explanation.GENERIC_REASON, "change me"),
                    "never_assign"
                );
                tasksOrNodesChanged = true;
            }
    ...
    private ClusterState.Builder addRandomTask(
        ...
        return addRandomTask(
            ...
            metadata,
            tasks,
            new Assignment(node, PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, randomAlphaOfLength(10)),
    ...
    private String addTask(PersistentTasksCustomMetadata.Builder tasks, String param, String node) {
        ...
        tasks.addTask(
            ...
            new Assignment(node, PersistentTasksCustomMetadata.Explanation.ASSIGNMENT_SUCCESSFUL, "explanation: " + param)
        );
        return id;
    }
