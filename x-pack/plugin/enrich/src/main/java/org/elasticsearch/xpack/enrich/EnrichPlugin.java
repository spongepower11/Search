...
public class EnrichPlugin extends Plugin implements SystemIndexPlugin, IngestPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return List.of(
            new NamedWriteableRegistry.Entry(MetadataSection.class, EnrichMetadata.TYPE, EnrichMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                EnrichMetadata.TYPE,
                in -> EnrichMetadata.readDiffFrom(MetadataSection.class, EnrichMetadata.TYPE, in)
            )
        );
    }
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return List.of(
            new NamedXContentRegistry.Entry(MetadataSection.class, new ParseField(EnrichMetadata.TYPE), EnrichMetadata::fromXContent)
        );
    }
